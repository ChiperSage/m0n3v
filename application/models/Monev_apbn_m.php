...
class Monev_apbn_m extends CI_Model{
    ...
    public function view_persatker_rup()
    {
      ...
      AND (r.sumber_dana = 'APBN') AND r.penyedia_didalam_swakelola = 'tidak') as pt_paket,

      (SELECT SUM(r.pagu_rup) FROM tb_rup r
      WHERE r.id_satker = a.kode
      AND (r.metode_pemilihan = 'Tender' OR r.metode_pemilihan = 'Tender Cepat' OR r.metode_pemilihan = 'Seleksi')
      AND left(r.akhir_pekerjaan,4) = $tahun AND (r.status_aktif = 'ya' AND r.status_umumkan = 'sudah')
      AND (r.sumber_dana = 'APBN') AND r.penyedia_didalam_swakelola = 'tidak') as pt_pagu,
      ...
      AND left(r.akhir_pekerjaan,4) = $tahun AND (r.status_aktif = 'ya' AND r.status_umumkan = 'sudah')
      AND (r.sumber_dana = 'APBN') AND r.penyedia_didalam_swakelola = 'tidak') as pl_paket,

      (SELECT SUM(r.pagu_rup) FROM tb_rup r
      WHERE r.id_satker = a.kode
      AND (r.metode_pemilihan = 'Penunjukan Langsung' AND r.pagu_rup > 200000000)
      AND left(r.akhir_pekerjaan,4) = $tahun AND (r.status_aktif = 'ya' AND r.status_umumkan = 'sudah')
      AND (r.sumber_dana = 'APBN') AND r.penyedia_didalam_swakelola = 'tidak') as pl_pagu,
      ...
      AND (r.metode_pemilihan = 'Penunjukan Langsung' AND r.pagu_rup <= 200000000)
      AND left(r.akhir_pekerjaan,4) = $tahun AND (r.status_aktif = 'ya' AND r.status_umumkan = 'sudah')
      AND (r.sumber_dana = 'APBN') AND r.penyedia_didalam_swakelola = 'tidak') as pl1_paket,

      (SELECT SUM(r.pagu_rup) FROM tb_rup r
      WHERE r.id_satker = a.kode
      AND (r.metode_pemilihan = 'Penunjukan Langsung' AND r.pagu_rup <= 200000000)
      AND left(r.akhir_pekerjaan,4) = $tahun AND (r.status_aktif = 'ya' AND r.status_umumkan = 'sudah')
      AND (r.sumber_dana = 'APBN') AND r.penyedia_didalam_swakelola = 'tidak') as pl1_pagu,
      ...
      AND left(r.akhir_pekerjaan,4) = $tahun AND (r.status_aktif = 'ya' AND r.status_umumkan = 'sudah')
      AND (r.sumber_dana = 'APBN') AND r.penyedia_didalam_swakelola = 'tidak') as pl2_paket,

      (SELECT SUM(r.pagu_rup) FROM tb_rup r
      WHERE r.id_satker = a.kode AND r.metode_pemilihan = 'Pengadaan Langsung'
      AND left(r.akhir_pekerjaan,4) = $tahun AND (r.status_aktif = 'ya' AND r.status_umumkan = 'sudah')
      AND (r.sumber_dana = 'APBN') AND r.penyedia_didalam_swakelola = 'tidak') as pl2_pagu,
      ...
      AND left(r.akhir_pekerjaan,4) = $tahun AND (r.status_aktif = 'ya' AND r.status_umumkan = 'sudah')
      AND (r.sumber_dana = 'APBN') AND r.penyedia_didalam_swakelola = 'tidak') as ep_paket,

      (SELECT SUM(r.pagu_rup) FROM tb_rup r
      WHERE r.id_satker = a.kode AND r.metode_pemilihan = 'e-Purchasing'
      AND left(r.akhir_pekerjaan,4) = $tahun AND (r.status_aktif = 'ya' AND r.status_umumkan = 'sudah')
      AND (r.sumber_dana = 'APBN') AND r.penyedia_didalam_swakelola = 'tidak') as ep_pagu,
      ...
      WHERE r.id_satker = a.kode
      AND left(r.akhir_pekerjaan,4) = $tahun AND (r.status_aktif = 'ya' AND r.status_umumkan = 'sudah')
      AND (r.sumber_dana = 'APBN') AND r.penyedia_didalam_swakelola = 'ya') as sw_paket,

      (SELECT SUM(r.pagu_rup) FROM tb_rup r
      WHERE r.id_satker = a.kode
      AND left(r.akhir_pekerjaan,4) = $tahun AND (r.status_aktif = 'ya' AND r.status_umumkan = 'sudah')
      AND (r.sumber_dana = 'APBN') AND r.penyedia_didalam_swakelola = 'ya') as sw_pagu
    ...
    public function get_total()
    {
      ...
      -- tender paket dan pagu
      COUNT(c.kode_rup) as tpaket, SUM(b.pagu_rup) as tpagu,

      -- non tender paket dan pagu
      (SELECT count(t.kode_rup) FROM tb_non_tender t
      LEFT JOIN tb_rup r ON t.kode_rup = r.kode_rup
      WHERE r.sumber_dana = 'APBN' AND t.tahun LIKE '%$tahun%' AND ( (t.status_lelang = 0 AND t.paket_status = 0 AND t.ukpbj = '1106.00')
      ...
      AND r.sumber_dana = 'APBN' AND ( (t.status_lelang = 1 AND t.paket_status = 1 AND r.sumber_dana = 'APBN') OR (t.status_lelang = 0 AND t.paket_status = 0 AND t.ukpbj = '1106.00' AND r.sumber_dana = 'APBN')
      ...
      LEFT JOIN tb_rup r ON t.kode_rup = r.kode_rup
      WHERE r.sumber_dana = 'APBN' AND r.id_satker = a.kode AND t.tahun LIKE '%$tahun%'
    ...
    -- Menghitung SP TOTAL
     ...
     LEFT JOIN tb_lelang t ON pk.paket_id = t.kode_rup
     WHERE t.tahun LIKE '%$tahun%'
     ...
     AND r.sumber_dana = 'APBN' AND pk.paket_status = 2) as tsp,
      ...
      WHERE l.tahun = $tahun AND v.status = 5 AND r.sumber_dana = 'APBN') as review_belum,

      (SELECT COUNT(v.kode_rup) FROM tb_review v
      LEFT JOIN tb_rup r ON v.kode_rup = r.kode_rup
      LEFT JOIN tb_lelang l ON r.kode_rup = l.kode_rup
  	  WHERE l.tahun = $tahun AND v.status = 0 AND r.sumber_dana = 'APBN' ) as review_pokja,

      (SELECT COUNT(v.kode_rup) FROM tb_review v
	    LEFT JOIN tb_rup r ON v.kode_rup = r.kode_rup
      LEFT JOIN tb_lelang l ON r.kode_rup = l.kode_rup
      WHERE l.tahun = $tahun AND v.status = 1 AND r.sumber_dana = 'APBN') as review_skpa,

      (SELECT COUNT(v.kode_rup) FROM tb_review v
	    LEFT JOIN tb_rup r ON v.kode_rup = r.kode_rup
      LEFT JOIN tb_lelang l ON r.kode_rup = l.kode_rup
      WHERE l.tahun = $tahun AND v.status = 2 AND r.sumber_dana = 'APBN' ) as review_selesai,

      (SELECT COUNT(v.kode_rup) FROM tb_review v
	    LEFT JOIN tb_rup r ON v.kode_rup = r.kode_rup
      LEFT JOIN tb_lelang l ON r.kode_rup = l.kode_rup
      WHERE l.tahun = $tahun AND r.sumber_dana = 'APBN') as review_total,
      ...
      (SELECT COUNT(r.kode_rup) FROM tb_rup r
      LEFT JOIN tb_lelang l ON r.kode_rup = l.kode_rup
      WHERE l.tahun = $tahun AND ((l.status_lelang = 1 AND l.menang = 5 AND r.sumber_dana = 'APBN') )
      ...
      (SELECT COUNT(r.kode_rup) FROM tb_rup r
      LEFT JOIN tb_lelang l ON r.kode_rup = l.kode_rup
      WHERE l.tahun = $tahun AND ((l.status_lelang = 1 AND l.menang = 5 AND r.sumber_dana = 'APBN') ) ) as sup,

      -- total batal

      (SELECT COUNT(r.kode_rup) FROM tb_rup r
      INNER JOIN tb_batal l ON r.kode_rup = l.batal_paket
      WHERE r.jenis_pengadaan LIKE '%pekerjaan konstruksi%' AND r.sumber_dana = 'APBN') as pb_kt,

      (SELECT COUNT(r.kode_rup) FROM tb_rup r
      INNER JOIN tb_batal l ON r.kode_rup = l.batal_paket
      WHERE r.jenis_pengadaan LIKE '%jasa konsultansi%' AND r.sumber_dana = 'APBN') as pb_ks,

      (SELECT COUNT(r.kode_rup) FROM tb_rup r
      INNER JOIN tb_batal b ON r.kode_rup = b.batal_paket
      WHERE r.jenis_pengadaan LIKE '%barang%' AND r.sumber_dana = 'APBN') as pb_b,

      (SELECT COUNT(r.kode_rup) FROM tb_rup r
      INNER JOIN tb_batal l ON r.kode_rup = l.batal_paket
      WHERE r.jenis_pengadaan LIKE '%jasa lainnya%' AND r.sumber_dana = 'APBN') as pb_j,

      (SELECT COUNT(r.kode_rup) FROM tb_rup r
      INNER JOIN tb_batal b ON r.kode_rup = b.batal_paket AND r.sumber_dana = 'APBN') as spb
      ...
      AND ((c.status_lelang = 1 AND c.status_lelang = 1 AND b.sumber_dana = 'APBN')
    ...
    public function get_laporan()
    {
      ...
      (SELECT count(t.kode_rup) FROM tb_non_tender t
      LEFT JOIN tb_rup r ON t.kode_rup = r.kode_rup
      WHERE r.id_satker = a.kode AND r.sumber_dana = 'APBN' AND t.tahun LIKE '%$tahun%'
      AND ( (t.status_lelang = 0 AND t.paket_status = 0 AND t.ukpbj = '1106.00')
      OR (t.status_lelang = 1 AND t.paket_status = 1 AND t.ukpbj = '1106.00') )
      ) as tpaket_non_tender,
      ...
      WHERE r.id_satker = a.kode AND r.tahun = $tahun AND t.kode_rup = r.kode_rup AND t.status = 5 AND r.sumber_dana = 'APBN') as review_belum,

      (SELECT COUNT(t.kode_rup)
  	  FROM tb_review t, tb_rup r
  	  WHERE r.id_satker = a.kode AND r.tahun = $tahun AND t.kode_rup = r.kode_rup AND t.status = 0 AND r.sumber_dana = 'APBN') as review_pokja,

	    (SELECT COUNT(t.kode_rup)
	    FROM tb_review t, tb_rup r
	    WHERE r.id_satker = a.kode AND r.tahun = $tahun AND t.kode_rup = r.kode_rup AND t.status = 1 AND r.sumber_dana = 'APBN') as review_skpa,

	    (SELECT COUNT(t.kode_rup)
	    FROM tb_review t, tb_rup r
      WHERE r.id_satker = a.kode AND r.tahun = $tahun AND t.kode_rup = r.kode_rup AND t.status = 2 AND r.sumber_dana = 'APBN') as review_selesai,
      ...
      (SELECT COUNT(r.kode_rup) FROM tb_rup r
      INNER JOIN tb_batal l ON r.kode_rup = l.batal_paket
      WHERE r.id_satker = a.kode AND r.jenis_pengadaan LIKE '%pekerjaan konstruksi%' AND r.sumber_dana = 'APBN') as b_kt,

      (SELECT COUNT(r.kode_rup) FROM tb_rup r
      INNER JOIN tb_batal l ON r.kode_rup = l.batal_paket
      WHERE r.id_satker = a.kode AND r.jenis_pengadaan LIKE '%jasa konsultansi%' AND r.sumber_dana = 'APBN') as b_ks,

      (SELECT COUNT(r.kode_rup) FROM tb_rup r
      INNER JOIN tb_batal b ON r.kode_rup = b.batal_paket
      WHERE r.id_satker = a.kode AND r.jenis_pengadaan LIKE '%barang%' AND r.sumber_dana = 'APBN') as b_b,

      (SELECT COUNT(r.kode_rup) FROM tb_rup r
      INNER JOIN tb_batal l ON r.kode_rup = l.batal_paket
      WHERE r.id_satker = a.kode AND r.jenis_pengadaan LIKE '%jasa lainnya%' AND r.sumber_dana = 'APBN') as b_j

      FROM tb_skpa a
      LEFT JOIN tb_rup b ON a.kode = b.id_satker
      LEFT JOIN tb_lelang c ON b.kode_rup = c.kode_rup
      WHERE c.tahun = $tahun AND b.sumber_dana = 'APBN'
      AND ((c.status_lelang = 1 AND c.status_lelang = 1 AND b.sumber_dana = 'APBN')
