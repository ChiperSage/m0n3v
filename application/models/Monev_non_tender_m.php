...
class Monev_non_tender_m extends CI_Model{
    ...
    public function tender_per_skpa_total()
    {
      ...
      WHERE (r.metode_pemilihan = 'Tender')
      -- AND r.status_aktif = 'ya' AND r.status_umumkan = 'sudah' AND r.penyedia_didalam_swakelola = 'tidak'
      AND l.tahun LIKE '%$tahun%' AND (r.sumber_dana LIKE '%APBD%' OR r.sumber_dana LIKE '%BLUD%') AND r.penyedia_didalam_swakelola = 'tidak'
      ...
      -- Tender Cepat
      (SELECT COUNT(l.kode_lelang) FROM tb_lelang l
      LEFT JOIN tb_rup r ON l.kode_rup = r.kode_rup
      WHERE (r.metode_pemilihan = 'Tender Cepat')
      -- AND r.status_aktif = 'ya' AND r.status_umumkan = 'sudah' AND r.penyedia_didalam_swakelola = 'tidak'
      AND l.tahun LIKE '%$tahun%' AND (r.sumber_dana LIKE '%APBD%' OR r.sumber_dana LIKE '%BLUD%')
      AND ( (l.status_lelang = 1 AND l.ukpbj is null)
      OR (l.status_lelang = 0 AND l.ukpbj = '1106.00' AND l.status_aktif != 'non aktif')
      OR (l.status_lelang = 0 AND l.paket_status = 0 AND l.ukpbj = '1106.00' AND l.status_aktif != 'non aktif')
      OR (l.status_lelang = 1 AND l.paket_status = 1 AND l.ukpbj = '1106.00') )
      ...
      AND (r.sumber_dana LIKE '%APBD%' OR r.sumber_dana LIKE '%BLUD%') AND r.penyedia_didalam_swakelola = 'tidak'
      --
      AND (l.tahun LIKE '%$tahun%' AND r.sumber_dana != 'APBN') AND (l.status_lelang = 1 AND l.status_lelang = 1 AND l.ukpbj is null AND r.sumber_dana != 'APBN')
      OR (l.status_lelang = 0 AND l.ukpbj = '1106.00' AND r.sumber_dana != 'APBN')
      OR (l.status_lelang = 0 AND l.paket_status = 0 AND l.ukpbj = '1106.00' AND r.sumber_dana != 'APBN')
      OR (l.status_lelang = 1 AND l.paket_status = 1 AND l.ukpbj = '1106.00' AND r.sumber_dana != 'APBN')
      ) as pl_paket,
    ...
    public function get_total()
    {
     ...
     AND r.sumber_dana != 'APBN' AND pk.paket_status = 2) as tsp,
      ...
      WHERE (b.metode_pemilihan = 'Tender' OR b.metode_pemilihan = 'Tender Cepat' OR b.metode_pemilihan = 'Seleksi')
      AND c.tahun LIKE '%$tahun%' AND b.sumber_dana != 'APBN'
      AND ( (c.status_lelang = 1 AND c.ukpbj is null)
      OR (c.status_lelang = 0 AND c.ukpbj = '1106.00' AND c.status_aktif != 'non aktif')
    ...
    public function get_laporan()
    {
      ...
      $str = "SELECT kode, singkatan, COUNT(DISTINCT c.kode_rup) as tpaket, SUM(b.pagu_rup) as tpagu,
      ...
      (SELECT COUNT(DISTINCT pk.paket_id) FROM tb_sp_paket pk
      LEFT JOIN tb_non_tender n ON pk.paket_id = n.kode_rup
    ...
    public function get_total_non_tender()
    {
      ...
      AND ((t.status_lelang = 0 AND t.status_aktif != 'non aktif') OR (t.status_lelang = 0 AND t.paket_status = 0 AND t.status_aktif != 'non aktif') 
      OR (t.status_lelang = 1 AND t.paket_status = 1))) as tpaket_non_tender,

      (SELECT SUM(t.pagu) FROM tb_non_tender t
      LEFT JOIN tb_rup r ON t.kode_rup = r.kode_rup
      WHERE t.anggaran LIKE '%$tahun%' AND r.sumber_dana != 'APBN'
      AND ((t.status_lelang = 0) OR (t.status_lelang = 0 AND t.status_aktif != 'non aktif') OR (t.status_lelang = 0 AND t.paket_status = 0 AND t.status_aktif != 'non aktif') 
      OR (t.status_lelang = 1 AND t.paket_status = 1))) as tpagu_non_tender,
      ...
      (SELECT COUNT(DISTINCT t.kode_lelang) FROM tb_rup r
      LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      WHERE t.anggaran LIKE '%$tahun%' AND t.status_lelang = 1 AND t.menang = 0 AND t.status_aktif != 'non aktif' AND r.sumber_dana != 'APBN') as st,

      -- Total Umum Pemenang
      (SELECT COUNT(t.kode_rup) FROM tb_rup r
      LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      WHERE t.anggaran LIKE '%$tahun%' AND t.status_lelang = 1 AND t.menang = 5 AND r.sumber_dana != 'APBN' AND t.status_aktif != 'non aktif' AND r.jenis_pengadaan LIKE '%pekerjaan konstruksi%') as sup_kt,

      (SELECT COUNT(t.kode_rup) FROM tb_rup r
      LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      WHERE t.anggaran LIKE '%$tahun%' AND t.status_lelang = 1 AND t.menang = 5 AND r.sumber_dana != 'APBN' AND t.status_aktif != 'non aktif' AND r.jenis_pengadaan LIKE '%jasa konsultansi%') as sup_ks,

      (SELECT COUNT(t.kode_rup) FROM tb_rup r
      LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      WHERE t.anggaran LIKE '%$tahun%' AND t.status_lelang = 1 AND t.menang = 5 AND r.sumber_dana != 'APBN' AND t.status_aktif != 'non aktif' AND r.jenis_pengadaan LIKE '%barang%') as sup_b,

      (SELECT COUNT(t.kode_rup) FROM tb_rup r
      LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      WHERE t.anggaran LIKE '%$tahun%' AND t.status_lelang = 1 AND t.menang = 5 AND r.sumber_dana != 'APBN' AND t.status_aktif != 'non aktif' AND r.jenis_pengadaan LIKE '%jasa lainnya%') as sup_j,

      (SELECT COUNT(DISTINCT t.kode_lelang) FROM tb_rup r
      LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      WHERE t.anggaran LIKE '%$tahun%' AND t.status_lelang = 1 AND t.menang = 5 AND r.sumber_dana != 'APBN' AND t.status_aktif != 'non aktif') as sup,
      ...
      WHERE t.anggaran LIKE '%$tahun%' AND r.jenis_pengadaan LIKE '%pekerjaan konstruksi%' AND r.sumber_dana != 'APBN' AND t.status_aktif != 'non aktif') as pb_kt,

      (SELECT COUNT(t.kode_rup) FROM tb_rup r
      LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      INNER JOIN tb_batal l ON t.kode_rup = l.batal_paket
      WHERE t.anggaran LIKE '%$tahun%' AND r.jenis_pengadaan LIKE '%jasa konsultansi%' AND r.sumber_dana != 'APBN' AND t.status_aktif != 'non aktif') as pb_ks,

      (SELECT COUNT(t.kode_rup) FROM tb_rup r
      LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      INNER JOIN tb_batal l ON t.kode_rup = l.batal_paket
      WHERE t.anggaran LIKE '%$tahun%' AND r.jenis_pengadaan LIKE '%barang%' AND r.sumber_dana != 'APBN' AND t.status_aktif != 'non aktif') as pb_b,

      (SELECT COUNT(t.kode_rup) FROM tb_rup r
      LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      INNER JOIN tb_batal l ON t.kode_rup = l.batal_paket
      WHERE t.anggaran LIKE '%$tahun%' AND r.jenis_pengadaan LIKE '%jasa lainnya%' AND r.sumber_dana != 'APBN' AND t.status_aktif != 'non aktif') as pb_j,

      (SELECT COUNT(t.kode_rup) FROM tb_rup r
      LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      INNER JOIN tb_batal l ON t.kode_rup = l.batal_paket
      WHERE t.anggaran LIKE '%$tahun%' AND r.sumber_dana != 'APBN' AND t.status_aktif != 'non aktif') as spb
      ...
      OR (c.status_lelang = 1 AND c.paket_status = 1) ) LIMIT 1";
    ...
    public function get_laporan_non_tender()
    {
      ...
      LEFT JOIN tb_rup r ON t.kode_rup = r.kode_rup
      WHERE r.id_satker = a.kode
      AND t.anggaran = '$tahun' AND r.sumber_dana != 'APBN'
      ...
      LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      WHERE r.id_satker = a.kode AND r.sumber_dana != 'APBN'
      AND t.anggaran LIKE '%$tahun%' AND t.status_lelang = 0 AND t.status_aktif != 'non aktif'
      AND r.jenis_pengadaan LIKE '%pekerjaan konstruksi%') as bt_kt,
      ...
      (SELECT COUNT(t.kode_rup) FROM tb_rup r
      LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      WHERE r.id_satker = a.kode AND r.sumber_dana != 'APBN' AND t.anggaran LIKE '%$tahun%' AND t.status_lelang = 1 AND t.menang = 0 AND t.status_aktif != 'non aktif'
      AND r.jenis_pengadaan LIKE '%pekerjaan konstruksi%') as t_kt,
      ...
      LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      WHERE r.id_satker = a.kode
      AND t.anggaran LIKE '%$tahun%' AND t.status_lelang = 1 AND t.menang = 5 AND t.status_aktif != 'non aktif'
      AND r.jenis_pengadaan LIKE '%Pekerjaan Konstruksi%') as m_kt,
    ...
    public function get_total_non_tender_complete()
    {
      $tahun = date('Y');
      if(isset($_GET['tahun'])){
        $tahun = $_GET['tahun'];
      ...
      LEFT JOIN tb_rup r ON t.kode_rup = r.kode_rup
      WHERE t.anggaran LIKE '%$tahun%' AND r.sumber_dana != 'APBN' AND t.status_aktif != 'non aktif'
      AND ((t.status_lelang = 0) OR (t.status_lelang = 1 AND t.menang = 0) OR (t.status_lelang = 1 AND t.menang = 5))) as tpaket_non_tender,
      
      (SELECT SUM(t.pagu) FROM tb_non_tender_complete t
      LEFT JOIN tb_rup r ON t.kode_rup = r.kode_rup
      WHERE t.anggaran LIKE '%$tahun%' AND r.sumber_dana != 'APBN' AND t.status_aktif != 'non aktif'
      AND ((t.status_lelang = 0) OR (t.status_lelang = 1 AND t.menang = 0) OR (t.status_lelang = 1 AND t.menang = 5))) as tpagu_non_tender,
      ...
      (SELECT SUM(t.pagu) FROM tb_rup r
      LEFT JOIN tb_non_tender_complete t ON r.kode_rup = t.kode_rup
      WHERE t.anggaran LIKE '%$tahun%' AND t.status_lelang = 0 AND t.status_aktif != 'non aktif' AND r.sumber_dana != 'APBN'
      ) as sbt_pagu,
      ...
      (SELECT SUM(t.pagu) FROM tb_rup r
      LEFT JOIN tb_non_tender_complete t ON r.kode_rup = t.kode_rup
      WHERE t.anggaran LIKE '%$tahun%' AND t.status_lelang = 1 AND t.menang = 0 AND t.status_aktif != 'non aktif' AND r.sumber_dana != 'APBN') as st_pagu,
      ...
      (SELECT SUM(t.pagu) FROM tb_rup r
      LEFT JOIN tb_non_tender_complete t ON r.kode_rup = t.kode_rup
      WHERE t.anggaran LIKE '%$tahun%' AND t.status_lelang = 1 AND t.menang = 5 AND r.sumber_dana != 'APBN' AND t.status_aktif != 'non aktif') as sup_pagu,
    ...
    public function get_laporan_non_tender_complete()
    {
      $tahun = date('Y');
      if(isset($_GET['tahun'])){
        $tahun = $_GET['tahun'];
      ...
      $str = "SELECT a.kode, a.singkatan, a.nama,

      -- paket dan pagu

      (SELECT COUNT(t.kode_lelang) FROM tb_non_tender_complete t
      LEFT JOIN tb_rup r ON t.kode_rup = r.kode_rup
      WHERE r.id_satker = a.kode AND t.anggaran = '$tahun' AND r.sumber_dana != 'APBN'
      AND ((t.status_lelang = 0) OR (t.status_lelang = 1 AND t.menang = 0) OR (t.status_lelang = 1 AND t.menang = 5))) as tpaket_non_tender,
      ...
      (SELECT COUNT(t.kode_lelang) FROM tb_rup r
      LEFT JOIN tb_non_tender_complete t ON r.kode_rup = t.kode_rup
      WHERE r.id_satker = a.kode AND r.sumber_dana != 'APBN' AND t.anggaran = '$tahun' AND t.status_lelang = 1 AND t.menang = 0 AND t.status_aktif != 'non aktif'
      AND r.jenis_pengadaan LIKE '%pekerjaan konstruksi%') as t_kt,
      ...
      (SELECT SUM(t.pagu) FROM tb_rup r
      LEFT JOIN tb_non_tender_complete t ON r.kode_rup = t.kode_rup
      WHERE r.id_satker = a.kode AND r.sumber_dana != 'APBN' AND t.anggaran = '$tahun' AND t.status_lelang = 1 AND t.menang = 0 AND t.status_aktif != 'non aktif') as t_pagu,
      ...
      LEFT JOIN tb_non_tender_complete t ON r.kode_rup = t.kode_rup
      WHERE r.id_satker = a.kode AND r.sumber_dana != 'APBN'
      AND t.anggaran = '$tahun' AND t.status_lelang = 0 AND r.jenis_pengadaan LIKE '%pekerjaan konstruksi%') as bt_kt,

      (SELECT COUNT(t.kode_lelang) FROM tb_rup r
      LEFT JOIN tb_non_tender_complete t ON r.kode_rup = t.kode_rup
      WHERE r.id_satker = a.kode AND r.sumber_dana != 'APBN'
      AND t.anggaran = '$tahun' AND t.status_lelang = 0 AND r.jenis_pengadaan LIKE '%jasa konsultansi%') as bt_ks,

      (SELECT COUNT(t.kode_lelang) FROM tb_rup r
      LEFT JOIN tb_non_tender_complete t ON r.kode_rup = t.kode_rup
      WHERE r.id_satker = a.kode AND r.sumber_dana != 'APBN'
      AND t.anggaran = '$tahun' AND t.status_lelang = 0 AND r.jenis_pengadaan LIKE '%barang%') as bt_b,

      (SELECT COUNT(t.kode_lelang) FROM tb_rup r
      LEFT JOIN tb_non_tender_complete t ON r.kode_rup = t.kode_rup
      WHERE r.id_satker = a.kode AND r.sumber_dana != 'APBN'
      AND t.anggaran = '$tahun' AND t.status_lelang = 0 AND r.jenis_pengadaan LIKE '%jasa lainnya%') as bt_j,

      (SELECT SUM(t.pagu) FROM tb_rup r
      LEFT JOIN tb_non_tender_complete t ON r.kode_rup = t.kode_rup
      WHERE r.id_satker = a.kode AND r.sumber_dana != 'APBN'
      AND t.anggaran = '$tahun' AND t.status_lelang = 0) as bt_pagu,

      -- menang

      (SELECT COUNT(t.kode_lelang) FROM tb_rup r
      LEFT JOIN tb_non_tender_complete t ON r.kode_rup = t.kode_rup
      WHERE r.id_satker = a.kode AND t.anggaran = '$tahun' AND t.status_lelang = 1 AND t.menang = 5 AND t.status_aktif != 'non aktif'
      AND r.jenis_pengadaan LIKE '%Pekerjaan Konstruksi%') as m_kt,
      ...
      LEFT JOIN tb_non_tender_complete t ON r.kode_rup = t.kode_rup
      WHERE r.id_satker = a.kode
      AND t.anggaran = '$tahun' AND t.status_lelang = 1 AND t.menang = 5 AND t.status_aktif != 'non aktif') as m_pagu,
      
      -- batal
      (SELECT COUNT(t.kode_rup) FROM tb_rup r
      LEFT JOIN tb_batal b ON r.kode_rup = b.batal_paket
      LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      WHERE (t.tahun = '$tahun') AND r.id_satker = a.kode AND r.jenis_pengadaan LIKE '%pekerjaan konstruksi%') as b_kt,

      (SELECT COUNT(t.kode_rup) FROM tb_rup r
      LEFT JOIN tb_batal b ON r.kode_rup = b.batal_paket
      LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      WHERE (t.tahun = '$tahun') AND r.id_satker = a.kode AND r.jenis_pengadaan LIKE '%jasa konsultansi%') as b_ks,

      (SELECT COUNT(t.kode_rup) FROM tb_rup r
      LEFT JOIN tb_batal b ON r.kode_rup = b.batal_paket
      LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      WHERE (t.tahun = '$tahun') AND r.id_satker = a.kode AND r.jenis_pengadaan LIKE '%barang%') as b_b,

      (SELECT COUNT(t.kode_rup) FROM tb_rup r
      INNER JOIN tb_batal b ON r.kode_rup = b.batal_paket
      LEFT JOIN tb_non_tender t ON r.kode_rup = t.kode_rup
      WHERE (t.tahun = '$tahun') AND r.id_satker = a.kode AND r.jenis_pengadaan LIKE '%jasa lainnya%') as b_j
      
      FROM tb_skpa a
      WHERE a.nama NOT LIKE '%biro%' AND a.instansi != 'pusat'
    ...
    public function view_jenis_pengadaan($var)
    {
      ...
      AND status_aktif = 'ya' AND status_umumkan = 'sudah' AND (left(awal_pekerjaan,4) = 2019 OR left(akhir_pekerjaan,4) = 2019)";
