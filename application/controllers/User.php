...
class User extends CI_Controller {
	...
	public function create_user()
	{
		...
		else
		{
			...
			$this->data['paraf'] = array(
				'name' => 'paraf',
				'id' => 'paraf',
				'type' => 'text',
				'class' => 'form-control',
				'value' => $this->form_validation->set_value('paraf'),
			);
	...
	public function edit_user($id)
	{
		...
		$this->data['paraf'] = array(
			...
			'type' => 'text',
			'class' => 'form-control',
			'value' => $this->form_validation->set_value('paraf', $user->paraf),
		);
		$this->data['phone'] = array(
			'name' => 'phone',
			'id' => 'phone',
